...
#ifndef _APP_KBD_MATRIX_SETUP_3_H_
#define _APP_KBD_MATRIX_SETUP_3_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Keyboard) Application matrix of setup #3.
 *
 * @{
 ****************************************************************************************
 */
...
#define COLUMN_1_PORT		(2)	//port: 2, pin: 0
#define COLUMN_1_PIN		(0)

#define COLUMN_2_PORT		(2)	//port: 2, pin: 7
#define COLUMN_2_PIN		(7)

#define COLUMN_3_PORT		(2)	//port: 2, pin: 6
#define COLUMN_3_PIN		(6)

#define COLUMN_4_PORT		(1)	//port: 1, pin: 2
#define COLUMN_4_PIN		(2)

#define COLUMN_5_PORT		(1)	//port: 1, pin: 1
#define COLUMN_5_PIN		(1)

#define COLUMN_6_PORT		(2)	//port: 2, pin: 9
#define COLUMN_6_PIN		(9)

#define COLUMN_7_PORT		(2)	//port: 2, pin: 4
#define COLUMN_7_PIN		(4)

#define COLUMN_8_PORT		(0)	//port: 0, pin: 5
#define COLUMN_8_PIN		(5)

#define COLUMN_9_PORT		(2)	//port: 2, pin: 3
#define COLUMN_9_PIN		(3)

#define COLUMN_10_PORT		(0)	//port: 0, pin: 4
#define COLUMN_10_PIN		(4)

#define COLUMN_11_PORT		(2)	//port: 2, pin: 1
#define COLUMN_11_PIN		(1)

#define COLUMN_12_PORT		(2)	//port: 2, pin: 2
#define COLUMN_12_PIN		(2)

#define COLUMN_13_PORT		(1)	//port: 1, pin: 3
#define COLUMN_13_PIN		(3)

#define COLUMN_14_PORT		(0)	//port: 0, pin: 2
#define COLUMN_14_PIN		(2)

#define COLUMN_15_PORT		(0)	//port: 0, pin: 3
#define COLUMN_15_PIN		(3)
...
#define ROW_0_PORT			(3)	//port: 3, pin: 1
#define ROW_0_PIN			(1)

#define ROW_1_PORT			(3)	//port: 3, pin: 4
#define ROW_1_PIN			(4)

#define ROW_2_PORT			(3)	//port: 3, pin: 6
#define ROW_2_PIN			(6)

#define ROW_3_PORT			(3)	//port: 3, pin: 0
#define ROW_3_PIN			(0)

#define ROW_4_PORT			(3)	//port: 3, pin: 2
#define ROW_4_PIN			(2)

#define ROW_5_PORT			(3)	//port: 3, pin: 3
#define ROW_5_PIN			(3)

#define ROW_6_PORT			(3)	//port: 3, pin: 5
#define ROW_6_PIN			(5)

#define ROW_7_PORT			(3)	//port: 3, pin: 7
#define ROW_7_PIN			(7)
...
#endif //_APP_KBD_MATRIX_SETUP_3_H_
