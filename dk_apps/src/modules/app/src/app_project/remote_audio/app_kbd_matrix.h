...
#ifndef KEYBOARD_MEASURE_EXT_SLP_ON
#define KBD_NR_COMBINATIONS 0
#endif

#define MULTI_KEY_NOT_USED      0xFF    // if output is set to MULTI_KEY_NOT_USED then the key is ignored
...
#include "app_kbd_matrix_setup_12.h"
...
#include "app_kbd_matrix_setup_16.h"


#endif // MATRIX_SETUP

#if (!KBD_NR_COMBINATIONS)
const struct key_combinations_t *key_comb = NULL;
#endif

#if KBD_NR_INPUTS < 9
typedef uint8_t scan_t;
#elif KBD_NR_INPUTS < 17
