...
#ifndef _APP_KBD_MATRIX_SETUP_4_H_
#define _APP_KBD_MATRIX_SETUP_4_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Keyboard) Application matrix of setup #4.
 *
 * @{
 ****************************************************************************************
 */
...
#define ROW_6_PORT			(3)	//port: 3, pin: 1
#define ROW_6_PIN			(1)

#define ROW_7_PORT			(3)	//port: 3, pin: 2
#define ROW_7_PIN			(2)
...
#endif //_APP_KBD_MATRIX_SETUP_4_H_
