...
#ifndef _APP_KBD_KEY_MATRIX_SETUP_3_H_
        #define _APP_KBD_KEY_MATRIX_SETUP_3_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Keyboard) Application GPIO reservations for the matrix of setup #3.
 *
 * @{
 ****************************************************************************************
 */
...
#endif //_APP_KBD_KEY_MATRIX_SETUP_3_H_
