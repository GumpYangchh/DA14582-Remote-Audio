...
#ifndef _APP_KBD_KEY_MATRIX_SETUP_5_H_
    #define _APP_KBD_KEY_MATRIX_SETUP_5_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Keyboard) Application GPIO reservations for the matrix of setup #5.
 *
 * @{
 ****************************************************************************************
 */
...
__INLINE void declare_uart_used_pins()
{
#ifndef CFG_PRINTF
...
#endif //_APP_KBD_KEY_MATRIX_SETUP_5_H_
