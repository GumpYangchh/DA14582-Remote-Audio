...
#ifndef _APP_KBD_KEY_MATRIX_SETUP_2_H_
        #define _APP_KBD_KEY_MATRIX_SETUP_2_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Keyboard) Application GPIO reservations for the matrix of setup #2.
 *
 * @{
 ****************************************************************************************
 */
...
#endif //_APP_KBD_KEY_MATRIX_SETUP_2_H_
