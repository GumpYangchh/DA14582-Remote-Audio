...
#if (HAS_BMI055)
    {APP_MOT_TIMER,                         (ke_msg_func_t)app_motion_timer_handler},
    {APP_MOT_DIS_TIMER,                     (ke_msg_func_t)app_motion_disconnect_timer_handler},
#endif
...
#if (USE_CONNECTION_FSM)
    {APP_CON_FSM_TIMER,                     (ke_msg_func_t)app_con_fsm_timer_handler},  
    {APP_CON_FSM_ENC_TIMER,                 (ke_msg_func_t)app_con_fsm_enc_timer_handler},
    {APP_CON_FSM_ADV_TIMER,                 (ke_msg_func_t)app_con_fsm_adv_timer_handler},
    {GATTC_CMP_EVT,                         (ke_msg_func_t)app_con_fsm_gattc_svc_chng_cmp_evt_handler},
    {GAPM_ADDR_SOLVED_IND,                  (ke_msg_func_t)app_con_fsm_gapm_addr_solved_ind_handler},
    {GATTC_SVC_CHANGED_CFG_IND,             (ke_msg_func_t)app_con_fsm_service_changed_cfg_ind_handler},
    {GAPM_UPDATED_PRIVACY_IND,              (ke_msg_func_t)app_con_fsm_updated_privacy_ind_handler},
    {GAPM_UPDATED_RECON_ADDR_IND,           (ke_msg_func_t)app_con_fsm_updated_recon_addr_ind_handler},
    {APP_CON_FSM_START_ADV_MSG,             (ke_msg_func_t)app_con_fsm_start_adv_msg_handler},
    {APP_CON_FSM_TERMINATE_CONN_MSG,        (ke_msg_func_t)app_con_fsm_disconnect_cmd_handler},
    {APP_CON_FSM_INACTIVITY_TIMER,          (ke_msg_func_t)app_con_fsm_inactivity_timer_handler},
    {APP_CON_FSM_ALT_PAIR_TIMER,            (ke_msg_func_t)app_alt_pair_timer_handler},
